...
// mf typedefs
typedef int ( WINAPI * wmfSwapIntervalEXT)( int interval );
typedef BOOL  ( WINAPI * wmfGetDeviceGammaRamp3DFX)( HDC, LPVOID );
typedef BOOL  ( WINAPI * wmfSetDeviceGammaRamp3DFX)( HDC, LPVOID );
typedef int   ( WINAPI * wmfChoosePixelFormat )(HDC, CONST PIXELFORMATDESCRIPTOR *);
typedef int   ( WINAPI * wmfDescribePixelFormat) (HDC, int, UINT, LPPIXELFORMATDESCRIPTOR);
typedef int   ( WINAPI * wmfGetPixelFormat)(HDC);
typedef BOOL  ( WINAPI * wmfSetPixelFormat)(HDC, int, CONST PIXELFORMATDESCRIPTOR *);
typedef BOOL  ( WINAPI * wmfSwapBuffers)(HDC);
typedef BOOL  ( WINAPI * wmfCopyContext)(HGLRC, HGLRC, UINT);
typedef HGLRC ( WINAPI * wmfCreateContext)(HDC);
typedef HGLRC ( WINAPI * wmfCreateLayerContext)(HDC, int);
typedef BOOL  ( WINAPI * wmfDeleteContext)(HGLRC);
typedef HGLRC ( WINAPI * wmfGetCurrentContext)(VOID);
typedef HDC   ( WINAPI * wmfGetCurrentDC)(VOID);
typedef PROC  ( WINAPI * wmfGetProcAddress)(LPCSTR);
typedef BOOL  ( WINAPI * wmfMakeCurrent)(HDC, HGLRC);
typedef BOOL  ( WINAPI * wmfShareLists)(HGLRC, HGLRC);
typedef BOOL  ( WINAPI * wmfUseFontBitmaps)(HDC, DWORD, DWORD, DWORD);
typedef BOOL  ( WINAPI * wmfUseFontOutlines)(HDC, DWORD, DWORD, DWORD, FLOAT, FLOAT, int, LPGLYPHMETRICSFLOAT);
typedef BOOL ( WINAPI * wmfDescribeLayerPlane)(HDC, int, int, UINT, LPLAYERPLANEDESCRIPTOR);
typedef int  ( WINAPI * wmfSetLayerPaletteEntries)(HDC, int, int, int, CONST COLORREF *);
typedef int  ( WINAPI * wmfGetLayerPaletteEntries)(HDC, int, int, int, COLORREF *);
typedef BOOL ( WINAPI * wmfRealizeLayerPalette)(HDC, int, BOOL);
typedef BOOL ( WINAPI * wmfSwapLayerBuffers)(HDC, UINT);
// end mf typedefs
...
// MF typedefs
typedef void ( APIENTRY * mfAccum )(GLenum op, GLfloat value);
typedef void ( APIENTRY * mfAlphaFunc )(GLenum func, GLclampf ref);
typedef GLboolean ( APIENTRY * mfAreTexturesResident )(GLsizei n, const GLuint *textures, GLboolean *residences);
typedef void ( APIENTRY * mfArrayElement )(GLint i);
typedef void ( APIENTRY * mfBegin )(GLenum mode);
typedef void ( APIENTRY * mfBindTexture )(GLenum target, GLuint texture);
typedef void ( APIENTRY * mfBitmap )(GLsizei width, GLsizei height, GLfloat xorig, GLfloat yorig, GLfloat xmove, GLfloat ymove, const GLubyte *bitmap);
typedef void ( APIENTRY * mfBlendFunc )(GLenum sfactor, GLenum dfactor);
typedef void ( APIENTRY * mfCallList )(GLuint list);
typedef void ( APIENTRY * mfCallLists )(GLsizei n, GLenum type, const GLvoid *lists);
typedef void ( APIENTRY * mfClear )(GLbitfield mask);
typedef void ( APIENTRY * mfClearAccum )(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha);
typedef void ( APIENTRY * mfClearColor )(GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha);
typedef void ( APIENTRY * mfClearDepth )(GLclampd depth);
typedef void ( APIENTRY * mfClearIndex )(GLfloat c);
typedef void ( APIENTRY * mfClearStencil )(GLint s);
typedef void ( APIENTRY * mfClipPlane )(GLenum plane, const GLdouble *equation);
typedef void ( APIENTRY * mfColor3b )(GLbyte red, GLbyte green, GLbyte blue);
typedef void ( APIENTRY * mfColor3bv )(const GLbyte *v);
typedef void ( APIENTRY * mfColor3d )(GLdouble red, GLdouble green, GLdouble blue);
typedef void ( APIENTRY * mfColor3dv )(const GLdouble *v);
typedef void ( APIENTRY * mfColor3f )(GLfloat red, GLfloat green, GLfloat blue);
typedef void ( APIENTRY * mfColor3fv )(const GLfloat *v);
typedef void ( APIENTRY * mfColor3i )(GLint red, GLint green, GLint blue);
typedef void ( APIENTRY * mfColor3iv )(const GLint *v);
typedef void ( APIENTRY * mfColor3s )(GLshort red, GLshort green, GLshort blue);
typedef void ( APIENTRY * mfColor3sv )(const GLshort *v);
typedef void ( APIENTRY * mfColor3ub )(GLubyte red, GLubyte green, GLubyte blue);
typedef void ( APIENTRY * mfColor3ubv )(const GLubyte *v);
typedef void ( APIENTRY * mfColor3ui )(GLuint red, GLuint green, GLuint blue);
typedef void ( APIENTRY * mfColor3uiv )(const GLuint *v);
typedef void ( APIENTRY * mfColor3us )(GLushort red, GLushort green, GLushort blue);
typedef void ( APIENTRY * mfColor3usv )(const GLushort *v);
typedef void ( APIENTRY * mfColor4b )(GLbyte red, GLbyte green, GLbyte blue, GLbyte alpha);
typedef void ( APIENTRY * mfColor4bv )(const GLbyte *v);
typedef void ( APIENTRY * mfColor4d )(GLdouble red, GLdouble green, GLdouble blue, GLdouble alpha);
typedef void ( APIENTRY * mfColor4dv )(const GLdouble *v);
typedef void ( APIENTRY * mfColor4f )(GLfloat red, GLfloat green, GLfloat blue, GLfloat alpha);
typedef void ( APIENTRY * mfColor4fv )(const GLfloat *v);
typedef void ( APIENTRY * mfColor4i )(GLint red, GLint green, GLint blue, GLint alpha);
typedef void ( APIENTRY * mfColor4iv )(const GLint *v);
typedef void ( APIENTRY * mfColor4s )(GLshort red, GLshort green, GLshort blue, GLshort alpha);
typedef void ( APIENTRY * mfColor4sv )(const GLshort *v);
typedef void ( APIENTRY * mfColor4ub )(GLubyte red, GLubyte green, GLubyte blue, GLubyte alpha);
typedef void ( APIENTRY * mfColor4ubv )(const GLubyte *v);
typedef void ( APIENTRY * mfColor4ui )(GLuint red, GLuint green, GLuint blue, GLuint alpha);
typedef void ( APIENTRY * mfColor4uiv )(const GLuint *v);
typedef void ( APIENTRY * mfColor4us )(GLushort red, GLushort green, GLushort blue, GLushort alpha);
typedef void ( APIENTRY * mfColor4usv )(const GLushort *v);
typedef void ( APIENTRY * mfColorMask )(GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha);
typedef void ( APIENTRY * mfColorMaterial )(GLenum face, GLenum mode);
typedef void ( APIENTRY * mfColorPointer )(GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);
typedef void ( APIENTRY * mfCopyPixels )(GLint x, GLint y, GLsizei width, GLsizei height, GLenum type);
typedef void ( APIENTRY * mfCopyTexImage1D )(GLenum target, GLint level, GLenum internalFormat, GLint x, GLint y, GLsizei width, GLint border);
typedef void ( APIENTRY * mfCopyTexImage2D )(GLenum target, GLint level, GLenum internalFormat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border);
typedef void ( APIENTRY * mfCopyTexSubImage1D )(GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width);
typedef void ( APIENTRY * mfCopyTexSubImage2D )(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height);
typedef void ( APIENTRY * mfCullFace )(GLenum mode);
typedef void ( APIENTRY * mfDeleteLists )(GLuint list, GLsizei range);
typedef void ( APIENTRY * mfDeleteTextures )(GLsizei n, const GLuint *textures);
typedef void ( APIENTRY * mfDepthFunc )(GLenum func);
typedef void ( APIENTRY * mfDepthMask )(GLboolean flag);
typedef void ( APIENTRY * mfDepthRange )(GLclampd zNear, GLclampd zFar);
typedef void ( APIENTRY * mfDisable )(GLenum cap);
typedef void ( APIENTRY * mfDisableClientState )(GLenum array);
typedef void ( APIENTRY * mfDrawArrays )(GLenum mode, GLint first, GLsizei count);
typedef void ( APIENTRY * mfDrawBuffer )(GLenum mode);
typedef void ( APIENTRY * mfDrawElements )(GLenum mode, GLsizei count, GLenum type, const GLvoid *indices);
typedef void ( APIENTRY * mfDrawPixels )(GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels);
typedef void ( APIENTRY * mfEdgeFlag )(GLboolean flag);
typedef void ( APIENTRY * mfEdgeFlagPointer )(GLsizei stride, const GLvoid *pointer);
typedef void ( APIENTRY * mfEdgeFlagv )(const GLboolean *flag);
typedef void ( APIENTRY * mfEnable )(GLenum cap);
typedef void ( APIENTRY * mfEnableClientState )(GLenum array);
typedef void ( APIENTRY * mfEnd )(void);
typedef void ( APIENTRY * mfEndList )(void);
typedef void ( APIENTRY * mfEvalCoord1d )(GLdouble u);
typedef void ( APIENTRY * mfEvalCoord1dv )(const GLdouble *u);
typedef void ( APIENTRY * mfEvalCoord1f )(GLfloat u);
typedef void ( APIENTRY * mfEvalCoord1fv )(const GLfloat *u);
typedef void ( APIENTRY * mfEvalCoord2d )(GLdouble u, GLdouble v);
typedef void ( APIENTRY * mfEvalCoord2dv )(const GLdouble *u);
typedef void ( APIENTRY * mfEvalCoord2f )(GLfloat u, GLfloat v);
typedef void ( APIENTRY * mfEvalCoord2fv )(const GLfloat *u);
typedef void ( APIENTRY * mfEvalMesh1 )(GLenum mode, GLint i1, GLint i2);
typedef void ( APIENTRY * mfEvalMesh2 )(GLenum mode, GLint i1, GLint i2, GLint j1, GLint j2);
typedef void ( APIENTRY * mfEvalPoint1 )(GLint i);
typedef void ( APIENTRY * mfEvalPoint2 )(GLint i, GLint j);
typedef void ( APIENTRY * mfFeedbackBuffer )(GLsizei size, GLenum type, GLfloat *buffer);
typedef void ( APIENTRY * mfFinish )(void);
typedef void ( APIENTRY * mfFlush )(void);
typedef void ( APIENTRY * mfFogf )(GLenum pname, GLfloat param);
typedef void ( APIENTRY * mfFogfv )(GLenum pname, const GLfloat *params);
typedef void ( APIENTRY * mfFogi )(GLenum pname, GLint param);
typedef void ( APIENTRY * mfFogiv )(GLenum pname, const GLint *params);
typedef void ( APIENTRY * mfFrontFace )(GLenum mode);
typedef void ( APIENTRY * mfFrustum )(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar);
typedef GLuint ( APIENTRY * mfGenLists )(GLsizei range);
typedef void ( APIENTRY * mfGenTextures )(GLsizei n, GLuint *textures);
typedef void ( APIENTRY * mfGetBooleanv )(GLenum pname, GLboolean *params);
typedef void ( APIENTRY * mfGetClipPlane )(GLenum plane, GLdouble *equation);
typedef void ( APIENTRY * mfGetDoublev )(GLenum pname, GLdouble *params);
typedef GLenum ( APIENTRY * mfGetError )(void);
typedef void ( APIENTRY * mfGetFloatv )(GLenum pname, GLfloat *params);
typedef void ( APIENTRY * mfGetIntegerv )(GLenum pname, GLint *params);
typedef void ( APIENTRY * mfGetLightfv )(GLenum light, GLenum pname, GLfloat *params);
typedef void ( APIENTRY * mfGetLightiv )(GLenum light, GLenum pname, GLint *params);
typedef void ( APIENTRY * mfGetMapdv )(GLenum target, GLenum query, GLdouble *v);
typedef void ( APIENTRY * mfGetMapfv )(GLenum target, GLenum query, GLfloat *v);
typedef void ( APIENTRY * mfGetMapiv )(GLenum target, GLenum query, GLint *v);
typedef void ( APIENTRY * mfGetMaterialfv )(GLenum face, GLenum pname, GLfloat *params);
typedef void ( APIENTRY * mfGetMaterialiv )(GLenum face, GLenum pname, GLint *params);
typedef void ( APIENTRY * mfGetPixelMapfv )(GLenum map, GLfloat *values);
typedef void ( APIENTRY * mfGetPixelMapuiv )(GLenum map, GLuint *values);
typedef void ( APIENTRY * mfGetPixelMapusv )(GLenum map, GLushort *values);
typedef void ( APIENTRY * mfGetPointerv )(GLenum pname, GLvoid* *params);
typedef void ( APIENTRY * mfGetPolygonStipple )(GLubyte *mask);
typedef const GLubyte * ( APIENTRY * mfGetString )(GLenum name);
typedef void ( APIENTRY * mfGetTexEnvfv )(GLenum target, GLenum pname, GLfloat *params);
typedef void ( APIENTRY * mfGetTexEnviv )(GLenum target, GLenum pname, GLint *params);
typedef void ( APIENTRY * mfGetTexGendv )(GLenum coord, GLenum pname, GLdouble *params);
typedef void ( APIENTRY * mfGetTexGenfv )(GLenum coord, GLenum pname, GLfloat *params);
typedef void ( APIENTRY * mfGetTexGeniv )(GLenum coord, GLenum pname, GLint *params);
typedef void ( APIENTRY * mfGetTexImage )(GLenum target, GLint level, GLenum format, GLenum type, GLvoid *pixels);
typedef void ( APIENTRY * mfGetTexLevelParameterfv )(GLenum target, GLint level, GLenum pname, GLfloat *params);
typedef void ( APIENTRY * mfGetTexLevelParameteriv )(GLenum target, GLint level, GLenum pname, GLint *params);
typedef void ( APIENTRY * mfGetTexParameterfv )(GLenum target, GLenum pname, GLfloat *params);
typedef void ( APIENTRY * mfGetTexParameteriv )(GLenum target, GLenum pname, GLint *params);
typedef void ( APIENTRY * mfHint )(GLenum target, GLenum mode);
typedef void ( APIENTRY * mfIndexMask )(GLuint mask);
typedef void ( APIENTRY * mfIndexPointer )(GLenum type, GLsizei stride, const GLvoid *pointer);
typedef void ( APIENTRY * mfIndexd )(GLdouble c);
typedef void ( APIENTRY * mfIndexdv )(const GLdouble *c);
typedef void ( APIENTRY * mfIndexf )(GLfloat c);
typedef void ( APIENTRY * mfIndexfv )(const GLfloat *c);
typedef void ( APIENTRY * mfIndexi )(GLint c);
typedef void ( APIENTRY * mfIndexiv )(const GLint *c);
typedef void ( APIENTRY * mfIndexs )(GLshort c);
typedef void ( APIENTRY * mfIndexsv )(const GLshort *c);
typedef void ( APIENTRY * mfIndexub )(GLubyte c);
typedef void ( APIENTRY * mfIndexubv )(const GLubyte *c);
typedef void ( APIENTRY * mfInitNames )(void);
typedef void ( APIENTRY * mfInterleavedArrays )(GLenum format, GLsizei stride, const GLvoid *pointer);
typedef GLboolean ( APIENTRY * mfIsEnabled )(GLenum cap);
typedef GLboolean ( APIENTRY * mfIsList )(GLuint list);
typedef GLboolean ( APIENTRY * mfIsTexture )(GLuint texture);
typedef void ( APIENTRY * mfLightModelf )(GLenum pname, GLfloat param);
typedef void ( APIENTRY * mfLightModelfv )(GLenum pname, const GLfloat *params);
typedef void ( APIENTRY * mfLightModeli )(GLenum pname, GLint param);
typedef void ( APIENTRY * mfLightModeliv )(GLenum pname, const GLint *params);
typedef void ( APIENTRY * mfLightf )(GLenum light, GLenum pname, GLfloat param);
typedef void ( APIENTRY * mfLightfv )(GLenum light, GLenum pname, const GLfloat *params);
typedef void ( APIENTRY * mfLighti )(GLenum light, GLenum pname, GLint param);
typedef void ( APIENTRY * mfLightiv )(GLenum light, GLenum pname, const GLint *params);
typedef void ( APIENTRY * mfLineStipple )(GLint factor, GLushort pattern);
typedef void ( APIENTRY * mfLineWidth )(GLfloat width);
typedef void ( APIENTRY * mfListBase )(GLuint base);
typedef void ( APIENTRY * mfLoadIdentity )(void);
typedef void ( APIENTRY * mfLoadMatrixd )(const GLdouble *m);
typedef void ( APIENTRY * mfLoadMatrixf )(const GLfloat *m);
typedef void ( APIENTRY * mfLoadName )(GLuint name);
typedef void ( APIENTRY * mfLogicOp )(GLenum opcode);
typedef void ( APIENTRY * mfMap1d )(GLenum target, GLdouble u1, GLdouble u2, GLint stride, GLint order, const GLdouble *points);
typedef void ( APIENTRY * mfMap1f )(GLenum target, GLfloat u1, GLfloat u2, GLint stride, GLint order, const GLfloat *points);
typedef void ( APIENTRY * mfMap2d )(GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, const GLdouble *points);
typedef void ( APIENTRY * mfMap2f )(GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, const GLfloat *points);
typedef void ( APIENTRY * mfMapGrid1d )(GLint un, GLdouble u1, GLdouble u2);
typedef void ( APIENTRY * mfMapGrid1f )(GLint un, GLfloat u1, GLfloat u2);
typedef void ( APIENTRY * mfMapGrid2d )(GLint un, GLdouble u1, GLdouble u2, GLint vn, GLdouble v1, GLdouble v2);
typedef void ( APIENTRY * mfMapGrid2f )(GLint un, GLfloat u1, GLfloat u2, GLint vn, GLfloat v1, GLfloat v2);
typedef void ( APIENTRY * mfMaterialf )(GLenum face, GLenum pname, GLfloat param);
typedef void ( APIENTRY * mfMaterialfv )(GLenum face, GLenum pname, const GLfloat *params);
typedef void ( APIENTRY * mfMateriali )(GLenum face, GLenum pname, GLint param);
typedef void ( APIENTRY * mfMaterialiv )(GLenum face, GLenum pname, const GLint *params);
typedef void ( APIENTRY * mfMatrixMode )(GLenum mode);
typedef void ( APIENTRY * mfMultMatrixd )(const GLdouble *m);
typedef void ( APIENTRY * mfMultMatrixf )(const GLfloat *m);
typedef void ( APIENTRY * mfNewList )(GLuint list, GLenum mode);
typedef void ( APIENTRY * mfNormal3b )(GLbyte nx, GLbyte ny, GLbyte nz);
typedef void ( APIENTRY * mfNormal3bv )(const GLbyte *v);
typedef void ( APIENTRY * mfNormal3d )(GLdouble nx, GLdouble ny, GLdouble nz);
typedef void ( APIENTRY * mfNormal3dv )(const GLdouble *v);
typedef void ( APIENTRY * mfNormal3f )(GLfloat nx, GLfloat ny, GLfloat nz);
typedef void ( APIENTRY * mfNormal3fv )(const GLfloat *v);
typedef void ( APIENTRY * mfNormal3i )(GLint nx, GLint ny, GLint nz);
typedef void ( APIENTRY * mfNormal3iv )(const GLint *v);
typedef void ( APIENTRY * mfNormal3s )(GLshort nx, GLshort ny, GLshort nz);
typedef void ( APIENTRY * mfNormal3sv )(const GLshort *v);
typedef void ( APIENTRY * mfNormalPointer )(GLenum type, GLsizei stride, const GLvoid *pointer);
typedef void ( APIENTRY * mfOrtho )(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar);
typedef void ( APIENTRY * mfPassThrough )(GLfloat token);
typedef void ( APIENTRY * mfPixelMapfv )(GLenum map, GLsizei mapsize, const GLfloat *values);
typedef void ( APIENTRY * mfPixelMapuiv )(GLenum map, GLsizei mapsize, const GLuint *values);
typedef void ( APIENTRY * mfPixelMapusv )(GLenum map, GLsizei mapsize, const GLushort *values);
typedef void ( APIENTRY * mfPixelStoref )(GLenum pname, GLfloat param);
typedef void ( APIENTRY * mfPixelStorei )(GLenum pname, GLint param);
typedef void ( APIENTRY * mfPixelTransferf )(GLenum pname, GLfloat param);
typedef void ( APIENTRY * mfPixelTransferi )(GLenum pname, GLint param);
typedef void ( APIENTRY * mfPixelZoom )(GLfloat xfactor, GLfloat yfactor);
typedef void ( APIENTRY * mfPointSize )(GLfloat size);
typedef void ( APIENTRY * mfPolygonMode )(GLenum face, GLenum mode);
typedef void ( APIENTRY * mfPolygonOffset )(GLfloat factor, GLfloat units);
typedef void ( APIENTRY * mfPolygonStipple )(const GLubyte *mask);
typedef void ( APIENTRY * mfPopAttrib )(void);
typedef void ( APIENTRY * mfPopClientAttrib )(void);
typedef void ( APIENTRY * mfPopMatrix )(void);
typedef void ( APIENTRY * mfPopName )(void);
typedef void ( APIENTRY * mfPrioritizeTextures )(GLsizei n, const GLuint *textures, const GLclampf *priorities);
typedef void ( APIENTRY * mfPushAttrib )(GLbitfield mask);
typedef void ( APIENTRY * mfPushClientAttrib )(GLbitfield mask);
typedef void ( APIENTRY * mfPushMatrix )(void);
typedef void ( APIENTRY * mfPushName )(GLuint name);
typedef void ( APIENTRY * mfRasterPos2d )(GLdouble x, GLdouble y);
typedef void ( APIENTRY * mfRasterPos2dv )(const GLdouble *v);
typedef void ( APIENTRY * mfRasterPos2f )(GLfloat x, GLfloat y);
typedef void ( APIENTRY * mfRasterPos2fv )(const GLfloat *v);
typedef void ( APIENTRY * mfRasterPos2i )(GLint x, GLint y);
typedef void ( APIENTRY * mfRasterPos2iv )(const GLint *v);
typedef void ( APIENTRY * mfRasterPos2s )(GLshort x, GLshort y);
typedef void ( APIENTRY * mfRasterPos2sv )(const GLshort *v);
typedef void ( APIENTRY * mfRasterPos3d )(GLdouble x, GLdouble y, GLdouble z);
typedef void ( APIENTRY * mfRasterPos3dv )(const GLdouble *v);
typedef void ( APIENTRY * mfRasterPos3f )(GLfloat x, GLfloat y, GLfloat z);
typedef void ( APIENTRY * mfRasterPos3fv )(const GLfloat *v);
typedef void ( APIENTRY * mfRasterPos3i )(GLint x, GLint y, GLint z);
typedef void ( APIENTRY * mfRasterPos3iv )(const GLint *v);
typedef void ( APIENTRY * mfRasterPos3s )(GLshort x, GLshort y, GLshort z);
typedef void ( APIENTRY * mfRasterPos3sv )(const GLshort *v);
typedef void ( APIENTRY * mfRasterPos4d )(GLdouble x, GLdouble y, GLdouble z, GLdouble w);
typedef void ( APIENTRY * mfRasterPos4dv )(const GLdouble *v);
typedef void ( APIENTRY * mfRasterPos4f )(GLfloat x, GLfloat y, GLfloat z, GLfloat w);
typedef void ( APIENTRY * mfRasterPos4fv )(const GLfloat *v);
typedef void ( APIENTRY * mfRasterPos4i )(GLint x, GLint y, GLint z, GLint w);
typedef void ( APIENTRY * mfRasterPos4iv )(const GLint *v);
typedef void ( APIENTRY * mfRasterPos4s )(GLshort x, GLshort y, GLshort z, GLshort w);
typedef void ( APIENTRY * mfRasterPos4sv )(const GLshort *v);
typedef void ( APIENTRY * mfReadBuffer )(GLenum mode);
typedef void ( APIENTRY * mfReadPixels )(GLint x, GLint y, GLsizei width, GLsizei height, GLenum format, GLenum type, GLvoid *pixels);
typedef void ( APIENTRY * mfRectd )(GLdouble x1, GLdouble y1, GLdouble x2, GLdouble y2);
typedef void ( APIENTRY * mfRectdv )(const GLdouble *v1, const GLdouble *v2);
typedef void ( APIENTRY * mfRectf )(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2);
typedef void ( APIENTRY * mfRectfv )(const GLfloat *v1, const GLfloat *v2);
typedef void ( APIENTRY * mfRecti )(GLint x1, GLint y1, GLint x2, GLint y2);
typedef void ( APIENTRY * mfRectiv )(const GLint *v1, const GLint *v2);
typedef void ( APIENTRY * mfRects )(GLshort x1, GLshort y1, GLshort x2, GLshort y2);
typedef void ( APIENTRY * mfRectsv )(const GLshort *v1, const GLshort *v2);
typedef GLint ( APIENTRY * mfRenderMode )(GLenum mode);
typedef void ( APIENTRY * mfRotated )(GLdouble angle, GLdouble x, GLdouble y, GLdouble z);
typedef void ( APIENTRY * mfRotatef )(GLfloat angle, GLfloat x, GLfloat y, GLfloat z);
typedef void ( APIENTRY * mfScaled )(GLdouble x, GLdouble y, GLdouble z);
typedef void ( APIENTRY * mfScalef )(GLfloat x, GLfloat y, GLfloat z);
typedef void ( APIENTRY * mfScissor )(GLint x, GLint y, GLsizei width, GLsizei height);
typedef void ( APIENTRY * mfSelectBuffer )(GLsizei size, GLuint *buffer);
typedef void ( APIENTRY * mfShadeModel )(GLenum mode);
typedef void ( APIENTRY * mfStencilFunc )(GLenum func, GLint ref, GLuint mask);
typedef void ( APIENTRY * mfStencilMask )(GLuint mask);
typedef void ( APIENTRY * mfStencilOp )(GLenum fail, GLenum zfail, GLenum zpass);
typedef void ( APIENTRY * mfTexCoord1d )(GLdouble s);
typedef void ( APIENTRY * mfTexCoord1dv )(const GLdouble *v);
typedef void ( APIENTRY * mfTexCoord1f )(GLfloat s);
typedef void ( APIENTRY * mfTexCoord1fv )(const GLfloat *v);
typedef void ( APIENTRY * mfTexCoord1i )(GLint s);
typedef void ( APIENTRY * mfTexCoord1iv )(const GLint *v);
typedef void ( APIENTRY * mfTexCoord1s )(GLshort s);
typedef void ( APIENTRY * mfTexCoord1sv )(const GLshort *v);
typedef void ( APIENTRY * mfTexCoord2d )(GLdouble s, GLdouble t);
typedef void ( APIENTRY * mfTexCoord2dv )(const GLdouble *v);
typedef void ( APIENTRY * mfTexCoord2f )(GLfloat s, GLfloat t);
typedef void ( APIENTRY * mfTexCoord2fv )(const GLfloat *v);
typedef void ( APIENTRY * mfTexCoord2i )(GLint s, GLint t);
typedef void ( APIENTRY * mfTexCoord2iv )(const GLint *v);
typedef void ( APIENTRY * mfTexCoord2s )(GLshort s, GLshort t);
typedef void ( APIENTRY * mfTexCoord2sv )(const GLshort *v);
typedef void ( APIENTRY * mfTexCoord3d )(GLdouble s, GLdouble t, GLdouble r);
typedef void ( APIENTRY * mfTexCoord3dv )(const GLdouble *v);
typedef void ( APIENTRY * mfTexCoord3f )(GLfloat s, GLfloat t, GLfloat r);
typedef void ( APIENTRY * mfTexCoord3fv )(const GLfloat *v);
typedef void ( APIENTRY * mfTexCoord3i )(GLint s, GLint t, GLint r);
typedef void ( APIENTRY * mfTexCoord3iv )(const GLint *v);
typedef void ( APIENTRY * mfTexCoord3s )(GLshort s, GLshort t, GLshort r);
typedef void ( APIENTRY * mfTexCoord3sv )(const GLshort *v);
typedef void ( APIENTRY * mfTexCoord4d )(GLdouble s, GLdouble t, GLdouble r, GLdouble q);
typedef void ( APIENTRY * mfTexCoord4dv )(const GLdouble *v);
typedef void ( APIENTRY * mfTexCoord4f )(GLfloat s, GLfloat t, GLfloat r, GLfloat q);
typedef void ( APIENTRY * mfTexCoord4fv )(const GLfloat *v);
typedef void ( APIENTRY * mfTexCoord4i )(GLint s, GLint t, GLint r, GLint q);
typedef void ( APIENTRY * mfTexCoord4iv )(const GLint *v);
typedef void ( APIENTRY * mfTexCoord4s )(GLshort s, GLshort t, GLshort r, GLshort q);
typedef void ( APIENTRY * mfTexCoord4sv )(const GLshort *v);
typedef void ( APIENTRY * mfTexCoordPointer )(GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);
typedef void ( APIENTRY * mfTexEnvf )(GLenum target, GLenum pname, GLfloat param);
typedef void ( APIENTRY * mfTexEnvfv )(GLenum target, GLenum pname, const GLfloat *params);
typedef void ( APIENTRY * mfTexEnvi )(GLenum target, GLenum pname, GLint param);
typedef void ( APIENTRY * mfTexEnviv )(GLenum target, GLenum pname, const GLint *params);
typedef void ( APIENTRY * mfTexGend )(GLenum coord, GLenum pname, GLdouble param);
typedef void ( APIENTRY * mfTexGendv )(GLenum coord, GLenum pname, const GLdouble *params);
typedef void ( APIENTRY * mfTexGenf )(GLenum coord, GLenum pname, GLfloat param);
typedef void ( APIENTRY * mfTexGenfv )(GLenum coord, GLenum pname, const GLfloat *params);
typedef void ( APIENTRY * mfTexGeni )(GLenum coord, GLenum pname, GLint param);
typedef void ( APIENTRY * mfTexGeniv )(GLenum coord, GLenum pname, const GLint *params);
typedef void ( APIENTRY * mfTexImage1D )(GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
typedef void ( APIENTRY * mfTexImage2D )(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
typedef void ( APIENTRY * mfTexParameterf )(GLenum target, GLenum pname, GLfloat param);
typedef void ( APIENTRY * mfTexParameterfv )(GLenum target, GLenum pname, const GLfloat *params);
typedef void ( APIENTRY * mfTexParameteri )(GLenum target, GLenum pname, GLint param);
typedef void ( APIENTRY * mfTexParameteriv )(GLenum target, GLenum pname, const GLint *params);
typedef void ( APIENTRY * mfTexSubImage1D )(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid *pixels);
typedef void ( APIENTRY * mfTexSubImage2D )(GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels);
typedef void ( APIENTRY * mfTranslated )(GLdouble x, GLdouble y, GLdouble z);
typedef void ( APIENTRY * mfTranslatef )(GLfloat x, GLfloat y, GLfloat z);
typedef void ( APIENTRY * mfVertex2d )(GLdouble x, GLdouble y);
typedef void ( APIENTRY * mfVertex2dv )(const GLdouble *v);
typedef void ( APIENTRY * mfVertex2f )(GLfloat x, GLfloat y);
typedef void ( APIENTRY * mfVertex2fv )(const GLfloat *v);
typedef void ( APIENTRY * mfVertex2i )(GLint x, GLint y);
typedef void ( APIENTRY * mfVertex2iv )(const GLint *v);
typedef void ( APIENTRY * mfVertex2s )(GLshort x, GLshort y);
typedef void ( APIENTRY * mfVertex2sv )(const GLshort *v);
typedef void ( APIENTRY * mfVertex3d )(GLdouble x, GLdouble y, GLdouble z);
typedef void ( APIENTRY * mfVertex3dv )(const GLdouble *v);
typedef void ( APIENTRY * mfVertex3f )(GLfloat x, GLfloat y, GLfloat z);
typedef void ( APIENTRY * mfVertex3fv )(const GLfloat *v);
typedef void ( APIENTRY * mfVertex3i )(GLint x, GLint y, GLint z);
typedef void ( APIENTRY * mfVertex3iv )(const GLint *v);
typedef void ( APIENTRY * mfVertex3s )(GLshort x, GLshort y, GLshort z);
typedef void ( APIENTRY * mfVertex3sv )(const GLshort *v);
typedef void ( APIENTRY * mfVertex4d )(GLdouble x, GLdouble y, GLdouble z, GLdouble w);
typedef void ( APIENTRY * mfVertex4dv )(const GLdouble *v);
typedef void ( APIENTRY * mfVertex4f )(GLfloat x, GLfloat y, GLfloat z, GLfloat w);
typedef void ( APIENTRY * mfVertex4fv )(const GLfloat *v);
typedef void ( APIENTRY * mfVertex4i )(GLint x, GLint y, GLint z, GLint w);
typedef void ( APIENTRY * mfVertex4iv )(const GLint *v);
typedef void ( APIENTRY * mfVertex4s )(GLshort x, GLshort y, GLshort z, GLshort w);
typedef void ( APIENTRY * mfVertex4sv )(const GLshort *v);
typedef void ( APIENTRY * mfVertexPointer )(GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);
typedef void ( APIENTRY * mfViewport )(GLint x, GLint y, GLsizei width, GLsizei height);
// end MF typedefs
...
bool QGL_Init( const char *dllname )
{
	...
	qglAccum                     = dllAccum = reinterpret_cast<mfAccum>(GPA( "glAccum" ));
	qglAlphaFunc                 = dllAlphaFunc = reinterpret_cast<mfAlphaFunc>(GPA( "glAlphaFunc" ));
	qglAreTexturesResident       = dllAreTexturesResident = reinterpret_cast<mfAreTexturesResident>(GPA( "glAreTexturesResident" ));
	qglArrayElement              = dllArrayElement = reinterpret_cast<mfArrayElement>(GPA( "glArrayElement" ));
	qglBegin                     = dllBegin = reinterpret_cast<mfBegin>(GPA( "glBegin" ));
	qglBindTexture               = dllBindTexture = reinterpret_cast<mfBindTexture>(GPA( "glBindTexture" ));
	qglBitmap                    = dllBitmap = reinterpret_cast<mfBitmap>(GPA( "glBitmap" ));
	qglBlendFunc                 = dllBlendFunc = reinterpret_cast<mfBlendFunc>(GPA( "glBlendFunc" ));
	qglCallList                  = dllCallList = reinterpret_cast<mfCallList>(GPA( "glCallList" ));
	qglCallLists                 = dllCallLists = reinterpret_cast<mfCallLists>(GPA( "glCallLists" ));
	qglClear                     = dllClear = reinterpret_cast<mfClear>(GPA( "glClear" ));
	qglClearAccum                = dllClearAccum = reinterpret_cast<mfClearAccum>(GPA( "glClearAccum" ));
	qglClearColor                = dllClearColor = reinterpret_cast<mfClearColor>(GPA( "glClearColor" ));
	qglClearDepth                = dllClearDepth = reinterpret_cast<mfClearDepth>(GPA( "glClearDepth" ));
	qglClearIndex                = dllClearIndex = reinterpret_cast<mfClearIndex>(GPA( "glClearIndex" ));
	qglClearStencil              = dllClearStencil = reinterpret_cast<mfClearStencil>(GPA( "glClearStencil" ));
	qglClipPlane                 = dllClipPlane = reinterpret_cast<mfClipPlane>(GPA( "glClipPlane" ));
	qglColor3b                   = dllColor3b = reinterpret_cast<mfColor3b>(GPA( "glColor3b" ));
	qglColor3bv                  = dllColor3bv = reinterpret_cast<mfColor3bv>(GPA( "glColor3bv" ));
	qglColor3d                   = dllColor3d = reinterpret_cast<mfColor3d>(GPA( "glColor3d" ));
	qglColor3dv                  = dllColor3dv = reinterpret_cast<mfColor3dv>(GPA( "glColor3dv" ));
	qglColor3f                   = dllColor3f = reinterpret_cast<mfColor3f>(GPA( "glColor3f" ));
	qglColor3fv                  = dllColor3fv = reinterpret_cast<mfColor3fv>(GPA( "glColor3fv" ));
	qglColor3i                   = dllColor3i = reinterpret_cast<mfColor3i>(GPA( "glColor3i" ));
	qglColor3iv                  = dllColor3iv = reinterpret_cast<mfColor3iv>(GPA( "glColor3iv" ));
	qglColor3s                   = dllColor3s = reinterpret_cast<mfColor3s>(GPA( "glColor3s" ));
	qglColor3sv                  = dllColor3sv = reinterpret_cast<mfColor3sv>(GPA( "glColor3sv" ));
	qglColor3ub                  = dllColor3ub = reinterpret_cast<mfColor3ub>(GPA( "glColor3ub" ));
	qglColor3ubv                 = dllColor3ubv = reinterpret_cast<mfColor3ubv>(GPA( "glColor3ubv" ));
	qglColor3ui                  = dllColor3ui = reinterpret_cast<mfColor3ui>(GPA( "glColor3ui" ));
	qglColor3uiv                 = dllColor3uiv = reinterpret_cast<mfColor3uiv>(GPA( "glColor3uiv" ));
	qglColor3us                  = dllColor3us = reinterpret_cast<mfColor3us>(GPA( "glColor3us" ));
	qglColor3usv                 = dllColor3usv = reinterpret_cast<mfColor3usv>(GPA( "glColor3usv" ));
	qglColor4b                   = dllColor4b = reinterpret_cast<mfColor4b>(GPA( "glColor4b" ));
	qglColor4bv                  = dllColor4bv = reinterpret_cast<mfColor4bv>(GPA( "glColor4bv" ));
	qglColor4d                   = dllColor4d = reinterpret_cast<mfColor4d>(GPA( "glColor4d" ));
	qglColor4dv                  = dllColor4dv = reinterpret_cast<mfColor4dv>(GPA( "glColor4dv" ));
	qglColor4f                   = dllColor4f = reinterpret_cast<mfColor4f>(GPA( "glColor4f" ));
	qglColor4fv                  = dllColor4fv = reinterpret_cast<mfColor4fv>(GPA( "glColor4fv" ));
	qglColor4i                   = dllColor4i = reinterpret_cast<mfColor4i>(GPA( "glColor4i" ));
	qglColor4iv                  = dllColor4iv = reinterpret_cast<mfColor4iv>(GPA( "glColor4iv" ));
	qglColor4s                   = dllColor4s = reinterpret_cast<mfColor4s>(GPA( "glColor4s" ));
	qglColor4sv                  = dllColor4sv = reinterpret_cast<mfColor4sv>(GPA( "glColor4sv" ));
	qglColor4ub                  = dllColor4ub = reinterpret_cast<mfColor4ub>(GPA( "glColor4ub" ));
	qglColor4ubv                 = dllColor4ubv = reinterpret_cast<mfColor4ubv>(GPA( "glColor4ubv" ));
	qglColor4ui                  = dllColor4ui = reinterpret_cast<mfColor4ui>(GPA( "glColor4ui" ));
	qglColor4uiv                 = dllColor4uiv = reinterpret_cast<mfColor4uiv>(GPA( "glColor4uiv" ));
	qglColor4us                  = dllColor4us = reinterpret_cast<mfColor4us>(GPA( "glColor4us" ));
	qglColor4usv                 = dllColor4usv = reinterpret_cast<mfColor4usv>(GPA( "glColor4usv" ));
	qglColorMask                 = dllColorMask = reinterpret_cast<mfColorMask>(GPA( "glColorMask" ));
	qglColorMaterial             = dllColorMaterial = reinterpret_cast<mfColorMaterial>(GPA( "glColorMaterial" ));
	qglColorPointer              = dllColorPointer = reinterpret_cast<mfColorPointer>(GPA( "glColorPointer" ));
	qglCopyPixels                = dllCopyPixels = reinterpret_cast<mfCopyPixels>(GPA( "glCopyPixels" ));
	qglCopyTexImage1D            = dllCopyTexImage1D = reinterpret_cast<mfCopyTexImage1D>(GPA( "glCopyTexImage1D" ));
	qglCopyTexImage2D            = dllCopyTexImage2D = reinterpret_cast<mfCopyTexImage2D>(GPA( "glCopyTexImage2D" ));
	qglCopyTexSubImage1D         = dllCopyTexSubImage1D = reinterpret_cast<mfCopyTexSubImage1D>(GPA( "glCopyTexSubImage1D" ));
	qglCopyTexSubImage2D         = dllCopyTexSubImage2D = reinterpret_cast<mfCopyTexSubImage2D>(GPA( "glCopyTexSubImage2D" ));
	qglCullFace                  = dllCullFace = reinterpret_cast<mfCullFace>(GPA( "glCullFace" ));
	qglDeleteLists               = dllDeleteLists = reinterpret_cast<mfDeleteLists>(GPA( "glDeleteLists" ));
	qglDeleteTextures            = dllDeleteTextures = reinterpret_cast<mfDeleteTextures>(GPA( "glDeleteTextures" ));
	qglDepthFunc                 = dllDepthFunc = reinterpret_cast<mfDepthFunc>(GPA( "glDepthFunc" ));
	qglDepthMask                 = dllDepthMask = reinterpret_cast<mfDepthMask>(GPA( "glDepthMask" ));
	qglDepthRange                = dllDepthRange = reinterpret_cast<mfDepthRange>(GPA( "glDepthRange" ));
	qglDisable                   = dllDisable = reinterpret_cast<mfDisable>(GPA( "glDisable" ));
	qglDisableClientState        = dllDisableClientState = reinterpret_cast<mfDisableClientState>(GPA( "glDisableClientState" ));
	qglDrawArrays                = dllDrawArrays = reinterpret_cast<mfDrawArrays>(GPA( "glDrawArrays" ));
	qglDrawBuffer                = dllDrawBuffer = reinterpret_cast<mfDrawBuffer>(GPA( "glDrawBuffer" ));
	qglDrawElements              = dllDrawElements = reinterpret_cast<mfDrawElements>(GPA( "glDrawElements" ));
	qglDrawPixels                = dllDrawPixels = reinterpret_cast<mfDrawPixels>(GPA( "glDrawPixels" ));
	qglEdgeFlag                  = dllEdgeFlag = reinterpret_cast<mfEdgeFlag>(GPA( "glEdgeFlag" ));
	qglEdgeFlagPointer           = dllEdgeFlagPointer = reinterpret_cast<mfEdgeFlagPointer>(GPA( "glEdgeFlagPointer" ));
	qglEdgeFlagv                 = dllEdgeFlagv = reinterpret_cast<mfEdgeFlagv>(GPA( "glEdgeFlagv" ));
	qglEnable                    = 	dllEnable                    = reinterpret_cast<mfEnable>(GPA( "glEnable" ));
	qglEnableClientState         = 	dllEnableClientState         = reinterpret_cast<mfEnableClientState>(GPA( "glEnableClientState" ));
	qglEnd                       = 	dllEnd                       = reinterpret_cast<mfEnd>(GPA( "glEnd" ));
	qglEndList                   = 	dllEndList                   = reinterpret_cast<mfEndList>(GPA( "glEndList" ));
	qglEvalCoord1d				 = 	dllEvalCoord1d				 = reinterpret_cast<mfEvalCoord1d>(GPA( "glEvalCoord1d" ));
	qglEvalCoord1dv              = 	dllEvalCoord1dv              = reinterpret_cast<mfEvalCoord1dv>(GPA( "glEvalCoord1dv" ));
	qglEvalCoord1f               = 	dllEvalCoord1f               = reinterpret_cast<mfEvalCoord1f>(GPA( "glEvalCoord1f" ));
	qglEvalCoord1fv              = 	dllEvalCoord1fv              = reinterpret_cast<mfEvalCoord1fv>(GPA( "glEvalCoord1fv" ));
	qglEvalCoord2d               = 	dllEvalCoord2d               = reinterpret_cast<mfEvalCoord2d>(GPA( "glEvalCoord2d" ));
	qglEvalCoord2dv              = 	dllEvalCoord2dv              = reinterpret_cast<mfEvalCoord2dv>(GPA( "glEvalCoord2dv" ));
	qglEvalCoord2f               = 	dllEvalCoord2f               = reinterpret_cast<mfEvalCoord2f>(GPA( "glEvalCoord2f" ));
	qglEvalCoord2fv              = 	dllEvalCoord2fv              = reinterpret_cast<mfEvalCoord2fv>(GPA( "glEvalCoord2fv" ));
	qglEvalMesh1                 = 	dllEvalMesh1                 = reinterpret_cast<mfEvalMesh1>(GPA( "glEvalMesh1" ));
	qglEvalMesh2                 = 	dllEvalMesh2                 = reinterpret_cast<mfEvalMesh2>(GPA( "glEvalMesh2" ));
	qglEvalPoint1                = 	dllEvalPoint1                = reinterpret_cast<mfEvalPoint1>(GPA( "glEvalPoint1" ));
	qglEvalPoint2                = 	dllEvalPoint2                = reinterpret_cast<mfEvalPoint2>(GPA( "glEvalPoint2" ));
	qglFeedbackBuffer            = 	dllFeedbackBuffer            = reinterpret_cast<mfFeedbackBuffer>(GPA( "glFeedbackBuffer" ));
	qglFinish                    = 	dllFinish                    = reinterpret_cast<mfFinish>(GPA( "glFinish" ));
	qglFlush                     = 	dllFlush                     = reinterpret_cast<mfFlush>(GPA( "glFlush" ));
	qglFogf                      = 	dllFogf                      = reinterpret_cast<mfFogf>(GPA( "glFogf" ));
	qglFogfv                     = 	dllFogfv                     = reinterpret_cast<mfFogfv>(GPA( "glFogfv" ));
	qglFogi                      = 	dllFogi                      = reinterpret_cast<mfFogi>(GPA( "glFogi" ));
	qglFogiv                     = 	dllFogiv                     = reinterpret_cast<mfFogiv>(GPA( "glFogiv" ));
	qglFrontFace                 = 	dllFrontFace                 = reinterpret_cast<mfFrontFace>(GPA( "glFrontFace" ));
	qglFrustum                   = 	dllFrustum                   = reinterpret_cast<mfFrustum>(GPA( "glFrustum" ));
	qglGenLists                  = 	dllGenLists                  = reinterpret_cast<mfGenLists>(GPA( "glGenLists" ));//( GLuint (__stdcall * )(int) ) GPA( "glGenLists" ));
	qglGenTextures               = 	dllGenTextures               = reinterpret_cast<mfGenTextures>(GPA( "glGenTextures" ));
	qglGetBooleanv               = 	dllGetBooleanv               = reinterpret_cast<mfGetBooleanv>(GPA( "glGetBooleanv" ));
	qglGetClipPlane              = 	dllGetClipPlane              = reinterpret_cast<mfGetClipPlane>(GPA( "glGetClipPlane" ));
	qglGetDoublev                = 	dllGetDoublev                = reinterpret_cast<mfGetDoublev>(GPA( "glGetDoublev" ));
	qglGetError                  = 	dllGetError                  = reinterpret_cast<mfGetError>(GPA( "glGetError" ));//( GLenum (__stdcall * )(void) ) GPA( "glGetError" ));
	qglGetFloatv                 = 	dllGetFloatv                 = reinterpret_cast<mfGetFloatv>(GPA( "glGetFloatv" ));
	qglGetIntegerv               = 	dllGetIntegerv               = reinterpret_cast<mfGetIntegerv>(GPA( "glGetIntegerv" ));
	qglGetLightfv                = 	dllGetLightfv                = reinterpret_cast<mfGetLightfv>(GPA( "glGetLightfv" ));
	qglGetLightiv                = 	dllGetLightiv                = reinterpret_cast<mfGetLightiv>(GPA( "glGetLightiv" ));
	qglGetMapdv                  = 	dllGetMapdv                  = reinterpret_cast<mfGetMapdv>(GPA( "glGetMapdv" ));
	qglGetMapfv                  = 	dllGetMapfv                  = reinterpret_cast<mfGetMapfv>(GPA( "glGetMapfv" ));
	qglGetMapiv                  = 	dllGetMapiv                  = reinterpret_cast<mfGetMapiv>(GPA( "glGetMapiv" ));
	qglGetMaterialfv             = 	dllGetMaterialfv             = reinterpret_cast<mfGetMaterialfv>(GPA( "glGetMaterialfv" ));
	qglGetMaterialiv             = 	dllGetMaterialiv             = reinterpret_cast<mfGetMaterialiv>(GPA( "glGetMaterialiv" ));
	qglGetPixelMapfv             = 	dllGetPixelMapfv             = reinterpret_cast<mfGetPixelMapfv>(GPA( "glGetPixelMapfv" ));
	qglGetPixelMapuiv            = 	dllGetPixelMapuiv            = reinterpret_cast<mfGetPixelMapuiv>(GPA( "glGetPixelMapuiv" ));
	qglGetPixelMapusv            = 	dllGetPixelMapusv            = reinterpret_cast<mfGetPixelMapusv>(GPA( "glGetPixelMapusv" ));
	qglGetPointerv               = 	dllGetPointerv               = reinterpret_cast<mfGetPointerv>(GPA( "glGetPointerv" ));
	qglGetPolygonStipple         = 	dllGetPolygonStipple         = reinterpret_cast<mfGetPolygonStipple>(GPA( "glGetPolygonStipple" ));
	qglGetString                 = 	dllGetString                 = reinterpret_cast<mfGetString>(GPA( "glGetString" ));
	qglGetTexEnvfv               = 	dllGetTexEnvfv               = reinterpret_cast<mfGetTexEnvfv>(GPA( "glGetTexEnvfv" ));
	qglGetTexEnviv               = 	dllGetTexEnviv               = reinterpret_cast<mfGetTexEnviv>(GPA( "glGetTexEnviv" ));
	qglGetTexGendv               = 	dllGetTexGendv               = reinterpret_cast<mfGetTexGendv>(GPA( "glGetTexGendv" ));
	qglGetTexGenfv               = 	dllGetTexGenfv               = reinterpret_cast<mfGetTexGenfv>(GPA( "glGetTexGenfv" ));
	qglGetTexGeniv               = 	dllGetTexGeniv               = reinterpret_cast<mfGetTexGeniv>(GPA( "glGetTexGeniv" ));
	qglGetTexImage               = 	dllGetTexImage               = reinterpret_cast<mfGetTexImage>(GPA( "glGetTexImage" ));
	qglGetTexParameterfv         = 	dllGetTexParameterfv         = reinterpret_cast<mfGetTexParameterfv>(GPA( "glGetTexParameterfv" ));
	qglGetTexParameteriv         = 	dllGetTexParameteriv         = reinterpret_cast<mfGetTexParameteriv>(GPA( "glGetTexParameteriv" ));
	qglHint                      = 	dllHint                      = reinterpret_cast<mfHint>(GPA( "glHint" ));
	qglIndexMask                 = 	dllIndexMask                 = reinterpret_cast<mfIndexMask>(GPA( "glIndexMask" ));
	qglIndexPointer              = 	dllIndexPointer              = reinterpret_cast<mfIndexPointer>(GPA( "glIndexPointer" ));
	qglIndexd                    = 	dllIndexd                    = reinterpret_cast<mfIndexd>(GPA( "glIndexd" ));
	qglIndexdv                   = 	dllIndexdv                   = reinterpret_cast<mfIndexdv>(GPA( "glIndexdv" ));
	qglIndexf                    = 	dllIndexf                    = reinterpret_cast<mfIndexf>(GPA( "glIndexf" ));
	qglIndexfv                   = 	dllIndexfv                   = reinterpret_cast<mfIndexfv>(GPA( "glIndexfv" ));
	qglIndexi                    = 	dllIndexi                    = reinterpret_cast<mfIndexi>(GPA( "glIndexi" ));
	qglIndexiv                   = 	dllIndexiv                   = reinterpret_cast<mfIndexiv>(GPA( "glIndexiv" ));
	qglIndexs                    = 	dllIndexs                    = reinterpret_cast<mfIndexs>(GPA( "glIndexs" ));
	qglIndexsv                   = 	dllIndexsv                   = reinterpret_cast<mfIndexsv>(GPA( "glIndexsv" ));
	qglIndexub                   = 	dllIndexub                   = reinterpret_cast<mfIndexub>(GPA( "glIndexub" ));
	qglIndexubv                  = 	dllIndexubv                  = reinterpret_cast<mfIndexubv>(GPA( "glIndexubv" ));
	qglInitNames                 = 	dllInitNames                 = reinterpret_cast<mfInitNames>(GPA( "glInitNames" ));
	qglInterleavedArrays         = 	dllInterleavedArrays         = reinterpret_cast<mfInterleavedArrays>(GPA( "glInterleavedArrays" ));
	qglIsEnabled                 = 	dllIsEnabled                 = reinterpret_cast<mfIsEnabled>(GPA( "glIsEnabled" ));
	qglIsList                    = 	dllIsList                    = reinterpret_cast<mfIsList>(GPA( "glIsList" ));
	qglIsTexture                 = 	dllIsTexture                 = reinterpret_cast<mfIsTexture>(GPA( "glIsTexture" ));
	qglLightModelf               = 	dllLightModelf               = reinterpret_cast<mfLightModelf>(GPA( "glLightModelf" ));
	qglLightModelfv              = 	dllLightModelfv              = reinterpret_cast<mfLightModelfv>(GPA( "glLightModelfv" ));
	qglLightModeli               = 	dllLightModeli               = reinterpret_cast<mfLightModeli>(GPA( "glLightModeli" ));
	qglLightModeliv              = 	dllLightModeliv              = reinterpret_cast<mfLightModeliv>(GPA( "glLightModeliv" ));
	qglLightf                    = 	dllLightf                    = reinterpret_cast<mfLightf>(GPA( "glLightf" ));
	qglLightfv                   = 	dllLightfv                   = reinterpret_cast<mfLightfv>(GPA( "glLightfv" ));
	qglLighti                    = 	dllLighti                    = reinterpret_cast<mfLighti>(GPA( "glLighti" ));
	qglLightiv                   = 	dllLightiv                   = reinterpret_cast<mfLightiv>(GPA( "glLightiv" ));
	qglLineStipple               = 	dllLineStipple               = reinterpret_cast<mfLineStipple>(GPA( "glLineStipple" ));
	qglLineWidth                 = 	dllLineWidth                 = reinterpret_cast<mfLineWidth>(GPA( "glLineWidth" ));
	qglListBase                  = 	dllListBase                  = reinterpret_cast<mfListBase>(GPA( "glListBase" ));
	qglLoadIdentity              = 	dllLoadIdentity              = reinterpret_cast<mfLoadIdentity>(GPA( "glLoadIdentity" ));
	qglLoadMatrixd               = 	dllLoadMatrixd               = reinterpret_cast<mfLoadMatrixd>(GPA( "glLoadMatrixd" ));
	qglLoadMatrixf               = 	dllLoadMatrixf               = reinterpret_cast<mfLoadMatrixf>(GPA( "glLoadMatrixf" ));
	qglLoadName                  = 	dllLoadName                  = reinterpret_cast<mfLoadName>(GPA( "glLoadName" ));
	qglLogicOp                   = 	dllLogicOp                   = reinterpret_cast<mfLogicOp>(GPA( "glLogicOp" ));
	qglMap1d                     = 	dllMap1d                     = reinterpret_cast<mfMap1d>(GPA( "glMap1d" ));
	qglMap1f                     = 	dllMap1f                     = reinterpret_cast<mfMap1f>(GPA( "glMap1f" ));
	qglMap2d                     = 	dllMap2d                     = reinterpret_cast<mfMap2d>(GPA( "glMap2d" ));
	qglMap2f                     = 	dllMap2f                     = reinterpret_cast<mfMap2f>(GPA( "glMap2f" ));
	qglMapGrid1d                 = 	dllMapGrid1d                 = reinterpret_cast<mfMapGrid1d>(GPA( "glMapGrid1d" ));
	qglMapGrid1f                 = 	dllMapGrid1f                 = reinterpret_cast<mfMapGrid1f>(GPA( "glMapGrid1f" ));
	qglMapGrid2d                 = 	dllMapGrid2d                 = reinterpret_cast<mfMapGrid2d>(GPA( "glMapGrid2d" ));
	qglMapGrid2f                 = 	dllMapGrid2f                 = reinterpret_cast<mfMapGrid2f>(GPA( "glMapGrid2f" ));
	qglMaterialf                 = 	dllMaterialf                 = reinterpret_cast<mfMaterialf>(GPA( "glMaterialf" ));
	qglMaterialfv                = 	dllMaterialfv                = reinterpret_cast<mfMaterialfv>(GPA( "glMaterialfv" ));
	qglMateriali                 = 	dllMateriali                 = reinterpret_cast<mfMateriali>(GPA( "glMateriali" ));
	qglMaterialiv                = 	dllMaterialiv                = reinterpret_cast<mfMaterialiv>(GPA( "glMaterialiv" ));
	qglMatrixMode                = 	dllMatrixMode                = reinterpret_cast<mfMatrixMode>(GPA( "glMatrixMode" ));
	qglMultMatrixd               = 	dllMultMatrixd               = reinterpret_cast<mfMultMatrixd>(GPA( "glMultMatrixd" ));
	qglMultMatrixf               = 	dllMultMatrixf               = reinterpret_cast<mfMultMatrixf>(GPA( "glMultMatrixf" ));
	qglNewList                   = 	dllNewList                   = reinterpret_cast<mfNewList>(GPA( "glNewList" ));
	qglNormal3b                  = 	dllNormal3b                  = reinterpret_cast<mfNormal3b>(GPA( "glNormal3b" ));
	qglNormal3bv                 = 	dllNormal3bv                 = reinterpret_cast<mfNormal3bv>(GPA( "glNormal3bv" ));
	qglNormal3d                  = 	dllNormal3d                  = reinterpret_cast<mfNormal3d>(GPA( "glNormal3d" ));
	qglNormal3dv                 = 	dllNormal3dv                 = reinterpret_cast<mfNormal3dv>(GPA( "glNormal3dv" ));
	qglNormal3f                  = 	dllNormal3f                  = reinterpret_cast<mfNormal3f>(GPA( "glNormal3f" ));
	qglNormal3fv                 = 	dllNormal3fv                 = reinterpret_cast<mfNormal3fv>(GPA( "glNormal3fv" ));
	qglNormal3i                  = 	dllNormal3i                  = reinterpret_cast<mfNormal3i>(GPA( "glNormal3i" ));
	qglNormal3iv                 = 	dllNormal3iv                 = reinterpret_cast<mfNormal3iv>(GPA( "glNormal3iv" ));
	qglNormal3s                  = 	dllNormal3s                  = reinterpret_cast<mfNormal3s>(GPA( "glNormal3s" ));
	qglNormal3sv                 = 	dllNormal3sv                 = reinterpret_cast<mfNormal3sv>(GPA( "glNormal3sv" ));
	qglNormalPointer             = 	dllNormalPointer             = reinterpret_cast<mfNormalPointer>(GPA( "glNormalPointer" ));
	qglOrtho                     = 	dllOrtho                     = reinterpret_cast<mfOrtho>(GPA( "glOrtho" ));
	qglPassThrough               = 	dllPassThrough               = reinterpret_cast<mfPassThrough>(GPA( "glPassThrough" ));
	qglPixelMapfv                = 	dllPixelMapfv                = reinterpret_cast<mfPixelMapfv>(GPA( "glPixelMapfv" ));
	qglPixelMapuiv               = 	dllPixelMapuiv               = reinterpret_cast<mfPixelMapuiv>(GPA( "glPixelMapuiv" ));
	qglPixelMapusv               = 	dllPixelMapusv               = reinterpret_cast<mfPixelMapusv>(GPA( "glPixelMapusv" ));
	qglPixelStoref               = 	dllPixelStoref               = reinterpret_cast<mfPixelStoref>(GPA( "glPixelStoref" ));
	qglPixelStorei               = 	dllPixelStorei               = reinterpret_cast<mfPixelStorei>(GPA( "glPixelStorei" ));
	qglPixelTransferf            = 	dllPixelTransferf            = reinterpret_cast<mfPixelTransferf>(GPA( "glPixelTransferf" ));
	qglPixelTransferi            = 	dllPixelTransferi            = reinterpret_cast<mfPixelTransferi>(GPA( "glPixelTransferi" ));
	qglPixelZoom                 = 	dllPixelZoom                 = reinterpret_cast<mfPixelZoom>(GPA( "glPixelZoom" ));
	qglPointSize                 = 	dllPointSize                 = reinterpret_cast<mfPointSize>(GPA( "glPointSize" ));
	qglPolygonMode               = 	dllPolygonMode               = reinterpret_cast<mfPolygonMode>(GPA( "glPolygonMode" ));
	qglPolygonOffset             = 	dllPolygonOffset             = reinterpret_cast<mfPolygonOffset>(GPA( "glPolygonOffset" ));
	qglPolygonStipple            = 	dllPolygonStipple            = reinterpret_cast<mfPolygonStipple>(GPA( "glPolygonStipple" ));
	qglPopAttrib                 = 	dllPopAttrib                 = reinterpret_cast<mfPopAttrib>(GPA( "glPopAttrib" ));
	qglPopClientAttrib           = 	dllPopClientAttrib           = reinterpret_cast<mfPopClientAttrib>(GPA( "glPopClientAttrib" ));
	qglPopMatrix                 = 	dllPopMatrix                 = reinterpret_cast<mfPopMatrix>(GPA( "glPopMatrix" ));
	qglPopName                   = 	dllPopName                   = reinterpret_cast<mfPopName>(GPA( "glPopName" ));
	qglPrioritizeTextures        = 	dllPrioritizeTextures        = reinterpret_cast<mfPrioritizeTextures>(GPA( "glPrioritizeTextures" ));
	qglPushAttrib                = 	dllPushAttrib                = reinterpret_cast<mfPushAttrib>(GPA( "glPushAttrib" ));
	qglPushClientAttrib          = 	dllPushClientAttrib          = reinterpret_cast<mfPushClientAttrib>(GPA( "glPushClientAttrib" ));
	qglPushMatrix                = 	dllPushMatrix                = reinterpret_cast<mfPushMatrix>(GPA( "glPushMatrix" ));
	qglPushName                  = 	dllPushName                  = reinterpret_cast<mfPushName>(GPA( "glPushName" ));
	qglRasterPos2d               = 	dllRasterPos2d               = reinterpret_cast<mfRasterPos2d>(GPA( "glRasterPos2d" ));
	qglRasterPos2dv              = 	dllRasterPos2dv              = reinterpret_cast<mfRasterPos2dv>(GPA( "glRasterPos2dv" ));
	qglRasterPos2f               = 	dllRasterPos2f               = reinterpret_cast<mfRasterPos2f>(GPA( "glRasterPos2f" ));
	qglRasterPos2fv              = 	dllRasterPos2fv              = reinterpret_cast<mfRasterPos2fv>(GPA( "glRasterPos2fv" ));
	qglRasterPos2i               = 	dllRasterPos2i               = reinterpret_cast<mfRasterPos2i>(GPA( "glRasterPos2i" ));
	qglRasterPos2iv              = 	dllRasterPos2iv              = reinterpret_cast<mfRasterPos2iv>(GPA( "glRasterPos2iv" ));
	qglRasterPos2s               = 	dllRasterPos2s               = reinterpret_cast<mfRasterPos2s>(GPA( "glRasterPos2s" ));
	qglRasterPos2sv              = 	dllRasterPos2sv              = reinterpret_cast<mfRasterPos2sv>(GPA( "glRasterPos2sv" ));
	qglRasterPos3d               = 	dllRasterPos3d               = reinterpret_cast<mfRasterPos3d>(GPA( "glRasterPos3d" ));
	qglRasterPos3dv              = 	dllRasterPos3dv              = reinterpret_cast<mfRasterPos3dv>(GPA( "glRasterPos3dv" ));
	qglRasterPos3f               = 	dllRasterPos3f               = reinterpret_cast<mfRasterPos3f>(GPA( "glRasterPos3f" ));
	qglRasterPos3fv              = 	dllRasterPos3fv              = reinterpret_cast<mfRasterPos3fv>(GPA( "glRasterPos3fv" ));
	qglRasterPos3i               = 	dllRasterPos3i               = reinterpret_cast<mfRasterPos3i>(GPA( "glRasterPos3i" ));
	qglRasterPos3iv              = 	dllRasterPos3iv              = reinterpret_cast<mfRasterPos3iv>(GPA( "glRasterPos3iv" ));
	qglRasterPos3s               = 	dllRasterPos3s               = reinterpret_cast<mfRasterPos3s>(GPA( "glRasterPos3s" ));
	qglRasterPos3sv              = 	dllRasterPos3sv              = reinterpret_cast<mfRasterPos3sv>(GPA( "glRasterPos3sv" ));
	qglRasterPos4d               = 	dllRasterPos4d               = reinterpret_cast<mfRasterPos4d>(GPA( "glRasterPos4d" ));
	qglRasterPos4dv              = 	dllRasterPos4dv              = reinterpret_cast<mfRasterPos4dv>(GPA( "glRasterPos4dv" ));
	qglRasterPos4f               = 	dllRasterPos4f               = reinterpret_cast<mfRasterPos4f>(GPA( "glRasterPos4f" ));
	qglRasterPos4fv              = 	dllRasterPos4fv              = reinterpret_cast<mfRasterPos4fv>(GPA( "glRasterPos4fv" ));
	qglRasterPos4i               = 	dllRasterPos4i               = reinterpret_cast<mfRasterPos4i>(GPA( "glRasterPos4i" ));
	qglRasterPos4iv              = 	dllRasterPos4iv              = reinterpret_cast<mfRasterPos4iv>(GPA( "glRasterPos4iv" ));
	qglRasterPos4s               = 	dllRasterPos4s               = reinterpret_cast<mfRasterPos4s>(GPA( "glRasterPos4s" ));
	qglRasterPos4sv              = 	dllRasterPos4sv              = reinterpret_cast<mfRasterPos4sv>(GPA( "glRasterPos4sv" ));
	qglReadBuffer                = 	dllReadBuffer                = reinterpret_cast<mfReadBuffer>(GPA( "glReadBuffer" ));
	qglReadPixels                = 	dllReadPixels                = reinterpret_cast<mfReadPixels>(GPA( "glReadPixels" ));
	qglRectd                     = 	dllRectd                     = reinterpret_cast<mfRectd>(GPA( "glRectd" ));
	qglRectdv                    = 	dllRectdv                    = reinterpret_cast<mfRectdv>(GPA( "glRectdv" ));
	qglRectf                     = 	dllRectf                     = reinterpret_cast<mfRectf>(GPA( "glRectf" ));
	qglRectfv                    = 	dllRectfv                    = reinterpret_cast<mfRectfv>(GPA( "glRectfv" ));
	qglRecti                     = 	dllRecti                     = reinterpret_cast<mfRecti>(GPA( "glRecti" ));
	qglRectiv                    = 	dllRectiv                    = reinterpret_cast<mfRectiv>(GPA( "glRectiv" ));
	qglRects                     = 	dllRects                     = reinterpret_cast<mfRects>(GPA( "glRects" ));
	qglRectsv                    = 	dllRectsv                    = reinterpret_cast<mfRectsv>(GPA( "glRectsv" ));
	qglRenderMode                = 	dllRenderMode                = reinterpret_cast<mfRenderMode>(GPA( "glRenderMode" ));
	qglRotated                   = 	dllRotated                   = reinterpret_cast<mfRotated>(GPA( "glRotated" ));
	qglRotatef                   = 	dllRotatef                   = reinterpret_cast<mfRotatef>(GPA( "glRotatef" ));
	qglScaled                    = 	dllScaled                    = reinterpret_cast<mfScaled>(GPA( "glScaled" ));
	qglScalef                    = 	dllScalef                    = reinterpret_cast<mfScalef>(GPA( "glScalef" ));
	qglScissor                   = 	dllScissor                   = reinterpret_cast<mfScissor>(GPA( "glScissor" ));
	qglSelectBuffer              = 	dllSelectBuffer              = reinterpret_cast<mfSelectBuffer>(GPA( "glSelectBuffer" ));
	qglShadeModel                = 	dllShadeModel                = reinterpret_cast<mfShadeModel>(GPA( "glShadeModel" ));
	qglStencilFunc               = 	dllStencilFunc               = reinterpret_cast<mfStencilFunc>(GPA( "glStencilFunc" ));
	qglStencilMask               = 	dllStencilMask               = reinterpret_cast<mfStencilMask>(GPA( "glStencilMask" ));
	qglStencilOp                 = 	dllStencilOp                 = reinterpret_cast<mfStencilOp>(GPA( "glStencilOp" ));
	qglTexCoord1d                = 	dllTexCoord1d                = reinterpret_cast<mfTexCoord1d>(GPA( "glTexCoord1d" ));
	qglTexCoord1dv               = 	dllTexCoord1dv               = reinterpret_cast<mfTexCoord1dv>(GPA( "glTexCoord1dv" ));
	qglTexCoord1f                = 	dllTexCoord1f                = reinterpret_cast<mfTexCoord1f>(GPA( "glTexCoord1f" ));
	qglTexCoord1fv               = 	dllTexCoord1fv               = reinterpret_cast<mfTexCoord1fv>(GPA( "glTexCoord1fv" ));
	qglTexCoord1i                = 	dllTexCoord1i                = reinterpret_cast<mfTexCoord1i>(GPA( "glTexCoord1i" ));
	qglTexCoord1iv               = 	dllTexCoord1iv               = reinterpret_cast<mfTexCoord1iv>(GPA( "glTexCoord1iv" ));
	qglTexCoord1s                = 	dllTexCoord1s                = reinterpret_cast<mfTexCoord1s>(GPA( "glTexCoord1s" ));
	qglTexCoord1sv               = 	dllTexCoord1sv               = reinterpret_cast<mfTexCoord1sv>(GPA( "glTexCoord1sv" ));
	qglTexCoord2d                = 	dllTexCoord2d                = reinterpret_cast<mfTexCoord2d>(GPA( "glTexCoord2d" ));
	qglTexCoord2dv               = 	dllTexCoord2dv               = reinterpret_cast<mfTexCoord2dv>(GPA( "glTexCoord2dv" ));
	qglTexCoord2f                = 	dllTexCoord2f                = reinterpret_cast<mfTexCoord2f>(GPA( "glTexCoord2f" ));
	qglTexCoord2fv               = 	dllTexCoord2fv               = reinterpret_cast<mfTexCoord2fv>(GPA( "glTexCoord2fv" ));
	qglTexCoord2i                = 	dllTexCoord2i                = reinterpret_cast<mfTexCoord2i>(GPA( "glTexCoord2i" ));
	qglTexCoord2iv               = 	dllTexCoord2iv               = reinterpret_cast<mfTexCoord2iv>(GPA( "glTexCoord2iv" ));
	qglTexCoord2s                = 	dllTexCoord2s                = reinterpret_cast<mfTexCoord2s>(GPA( "glTexCoord2s" ));
	qglTexCoord2sv               = 	dllTexCoord2sv               = reinterpret_cast<mfTexCoord2sv>(GPA( "glTexCoord2sv" ));
	qglTexCoord3d                = 	dllTexCoord3d                = reinterpret_cast<mfTexCoord3d>(GPA( "glTexCoord3d" ));
	qglTexCoord3dv               = 	dllTexCoord3dv               = reinterpret_cast<mfTexCoord3dv>(GPA( "glTexCoord3dv" ));
	qglTexCoord3f                = 	dllTexCoord3f                = reinterpret_cast<mfTexCoord3f>(GPA( "glTexCoord3f" ));
	qglTexCoord3fv               = 	dllTexCoord3fv               = reinterpret_cast<mfTexCoord3fv>(GPA( "glTexCoord3fv" ));
	qglTexCoord3i                = 	dllTexCoord3i                = reinterpret_cast<mfTexCoord3i>(GPA( "glTexCoord3i" ));
	qglTexCoord3iv               = 	dllTexCoord3iv               = reinterpret_cast<mfTexCoord3iv>(GPA( "glTexCoord3iv" ));
	qglTexCoord3s                = 	dllTexCoord3s                = reinterpret_cast<mfTexCoord3s>(GPA( "glTexCoord3s" ));
	qglTexCoord3sv               = 	dllTexCoord3sv               = reinterpret_cast<mfTexCoord3sv>(GPA( "glTexCoord3sv" ));
	qglTexCoord4d                = 	dllTexCoord4d                = reinterpret_cast<mfTexCoord4d>(GPA( "glTexCoord4d" ));
	qglTexCoord4dv               = 	dllTexCoord4dv               = reinterpret_cast<mfTexCoord4dv>(GPA( "glTexCoord4dv" ));
	qglTexCoord4f                = 	dllTexCoord4f                = reinterpret_cast<mfTexCoord4f>(GPA( "glTexCoord4f" ));
	qglTexCoord4fv               = 	dllTexCoord4fv               = reinterpret_cast<mfTexCoord4fv>(GPA( "glTexCoord4fv" ));
	qglTexCoord4i                = 	dllTexCoord4i                = reinterpret_cast<mfTexCoord4i>(GPA( "glTexCoord4i" ));
	qglTexCoord4iv               = 	dllTexCoord4iv               = reinterpret_cast<mfTexCoord4iv>(GPA( "glTexCoord4iv" ));
	qglTexCoord4s                = 	dllTexCoord4s                = reinterpret_cast<mfTexCoord4s>(GPA( "glTexCoord4s" ));
	qglTexCoord4sv               = 	dllTexCoord4sv               = reinterpret_cast<mfTexCoord4sv>(GPA( "glTexCoord4sv" ));
	qglTexCoordPointer           = 	dllTexCoordPointer           = reinterpret_cast<mfTexCoordPointer>(GPA( "glTexCoordPointer" ));
	qglTexEnvf                   = 	dllTexEnvf                   = reinterpret_cast<mfTexEnvf>(GPA( "glTexEnvf" ));
	qglTexEnvfv                  = 	dllTexEnvfv                  = reinterpret_cast<mfTexEnvfv>(GPA( "glTexEnvfv" ));
	qglTexEnvi                   = 	dllTexEnvi                   = reinterpret_cast<mfTexEnvi>(GPA( "glTexEnvi" ));
	qglTexEnviv                  = 	dllTexEnviv                  = reinterpret_cast<mfTexEnviv>(GPA( "glTexEnviv" ));
	qglTexGend                   = 	dllTexGend                   = reinterpret_cast<mfTexGend>(GPA( "glTexGend" ));
	qglTexGendv                  = 	dllTexGendv                  = reinterpret_cast<mfTexGendv>(GPA( "glTexGendv" ));
	qglTexGenf                   = 	dllTexGenf                   = reinterpret_cast<mfTexGenf>(GPA( "glTexGenf" ));
	qglTexGenfv                  = 	dllTexGenfv                  = reinterpret_cast<mfTexGenfv>(GPA( "glTexGenfv" ));
	qglTexGeni                   = 	dllTexGeni                   = reinterpret_cast<mfTexGeni>(GPA( "glTexGeni" ));
	qglTexGeniv                  = 	dllTexGeniv                  = reinterpret_cast<mfTexGeniv>(GPA( "glTexGeniv" ));
	qglTexImage1D                = 	dllTexImage1D                = reinterpret_cast<mfTexImage1D>(GPA( "glTexImage1D" ));
	qglTexImage2D                = 	dllTexImage2D                = reinterpret_cast<mfTexImage2D>(GPA( "glTexImage2D" ));
	qglTexParameterf             = 	dllTexParameterf             = reinterpret_cast<mfTexParameterf>(GPA( "glTexParameterf" ));
	qglTexParameterfv            = 	dllTexParameterfv            = reinterpret_cast<mfTexParameterfv>(GPA( "glTexParameterfv" ));
	qglTexParameteri             = 	dllTexParameteri             = reinterpret_cast<mfTexParameteri>(GPA( "glTexParameteri" ));
	qglTexParameteriv            = 	dllTexParameteriv            = reinterpret_cast<mfTexParameteriv>(GPA( "glTexParameteriv" ));
	qglTexSubImage1D             = 	dllTexSubImage1D             = reinterpret_cast<mfTexSubImage1D>(GPA( "glTexSubImage1D" ));
	qglTexSubImage2D             = 	dllTexSubImage2D             = reinterpret_cast<mfTexSubImage2D>(GPA( "glTexSubImage2D" ));
	qglTranslated                = 	dllTranslated                = reinterpret_cast<mfTranslated>(GPA( "glTranslated" ));
	qglTranslatef                = 	dllTranslatef                = reinterpret_cast<mfTranslatef>(GPA( "glTranslatef" ));
	qglVertex2d                  = 	dllVertex2d                  = reinterpret_cast<mfVertex2d>(GPA( "glVertex2d" ));
	qglVertex2dv                 = 	dllVertex2dv                 = reinterpret_cast<mfVertex2dv>(GPA( "glVertex2dv" ));
	qglVertex2f                  = 	dllVertex2f                  = reinterpret_cast<mfVertex2f>(GPA( "glVertex2f" ));
	qglVertex2fv                 = 	dllVertex2fv                 = reinterpret_cast<mfVertex2fv>(GPA( "glVertex2fv" ));
	qglVertex2i                  = 	dllVertex2i                  = reinterpret_cast<mfVertex2i>(GPA( "glVertex2i" ));
	qglVertex2iv                 = 	dllVertex2iv                 = reinterpret_cast<mfVertex2iv>(GPA( "glVertex2iv" ));
	qglVertex2s                  = 	dllVertex2s                  = reinterpret_cast<mfVertex2s>(GPA( "glVertex2s" ));
	qglVertex2sv                 = 	dllVertex2sv                 = reinterpret_cast<mfVertex2sv>(GPA( "glVertex2sv" ));
	qglVertex3d                  = 	dllVertex3d                  = reinterpret_cast<mfVertex3d>(GPA( "glVertex3d" ));
	qglVertex3dv                 = 	dllVertex3dv                 = reinterpret_cast<mfVertex3dv>(GPA( "glVertex3dv" ));
	qglVertex3f                  = 	dllVertex3f                  = reinterpret_cast<mfVertex3f>(GPA( "glVertex3f" ));
	qglVertex3fv                 = 	dllVertex3fv                 = reinterpret_cast<mfVertex3fv>(GPA( "glVertex3fv" ));
	qglVertex3i                  = 	dllVertex3i                  = reinterpret_cast<mfVertex3i>(GPA( "glVertex3i" ));
	qglVertex3iv                 = 	dllVertex3iv                 = reinterpret_cast<mfVertex3iv>(GPA( "glVertex3iv" ));
	qglVertex3s                  = 	dllVertex3s                  = reinterpret_cast<mfVertex3s>(GPA( "glVertex3s" ));
	qglVertex3sv                 = 	dllVertex3sv                 = reinterpret_cast<mfVertex3sv>(GPA( "glVertex3sv" ));
	qglVertex4d                  = 	dllVertex4d                  = reinterpret_cast<mfVertex4d>(GPA( "glVertex4d" ));
	qglVertex4dv                 = 	dllVertex4dv                 = reinterpret_cast<mfVertex4dv>(GPA( "glVertex4dv" ));
	qglVertex4f                  = 	dllVertex4f                  = reinterpret_cast<mfVertex4f>(GPA( "glVertex4f" ));
	qglVertex4fv                 = 	dllVertex4fv                 = reinterpret_cast<mfVertex4fv>(GPA( "glVertex4fv" ));
	qglVertex4i                  = 	dllVertex4i                  = reinterpret_cast<mfVertex4i>(GPA( "glVertex4i" ));
	qglVertex4iv                 = 	dllVertex4iv                 = reinterpret_cast<mfVertex4iv>(GPA( "glVertex4iv" ));
	qglVertex4s                  = 	dllVertex4s                  = reinterpret_cast<mfVertex4s>(GPA( "glVertex4s" ));
	qglVertex4sv                 = 	dllVertex4sv                 = reinterpret_cast<mfVertex4sv>(GPA( "glVertex4sv" ));
	qglVertexPointer             = 	dllVertexPointer             = reinterpret_cast<mfVertexPointer>(GPA( "glVertexPointer" ));
	qglViewport                  = 	dllViewport                  = reinterpret_cast<mfViewport>(GPA( "glViewport" ));

	qwglCopyContext              = reinterpret_cast<wmfCopyContext>(GPA( "wglCopyContext" ));
	qwglCreateContext            = reinterpret_cast<wmfCreateContext>(GPA( "wglCreateContext" ));
	qwglCreateLayerContext       = reinterpret_cast<wmfCreateLayerContext>(GPA( "wglCreateLayerContext" ));
	qwglDeleteContext            = reinterpret_cast<wmfDeleteContext>(GPA( "wglDeleteContext" ));
	qwglDescribeLayerPlane       = reinterpret_cast<wmfDescribeLayerPlane>(GPA( "wglDescribeLayerPlane" ));
	qwglGetCurrentContext        = reinterpret_cast<wmfGetCurrentContext>(GPA( "wglGetCurrentContext" ));
	qwglGetCurrentDC             = reinterpret_cast<wmfGetCurrentDC>(GPA( "wglGetCurrentDC" ));
	qwglGetLayerPaletteEntries   = reinterpret_cast<wmfGetLayerPaletteEntries>(GPA( "wglGetLayerPaletteEntries" ));
	qwglGetProcAddress           = reinterpret_cast<wmfGetProcAddress>(GPA( "wglGetProcAddress" ));
	qwglMakeCurrent              = reinterpret_cast<wmfMakeCurrent>(GPA( "wglMakeCurrent" ));
	qwglRealizeLayerPalette      = reinterpret_cast<wmfRealizeLayerPalette>(GPA( "wglRealizeLayerPalette" ));
	qwglSetLayerPaletteEntries   = reinterpret_cast<wmfSetLayerPaletteEntries>(GPA( "wglSetLayerPaletteEntries" ));
	qwglShareLists               = reinterpret_cast<wmfShareLists>(GPA( "wglShareLists" ));
	qwglSwapLayerBuffers         = reinterpret_cast<wmfSwapLayerBuffers>(GPA( "wglSwapLayerBuffers" ));
	qwglUseFontBitmaps           = reinterpret_cast<wmfUseFontBitmaps>(GPA( "wglUseFontBitmapsA" ));
	qwglUseFontOutlines          = reinterpret_cast<wmfUseFontOutlines>(GPA( "wglUseFontOutlinesA" ));

	qwglChoosePixelFormat        = reinterpret_cast<wmfChoosePixelFormat>(GPA( "wglChoosePixelFormat" ));
	qwglDescribePixelFormat      = reinterpret_cast<wmfDescribePixelFormat>(GPA( "wglDescribePixelFormat" ));
	qwglGetPixelFormat           = reinterpret_cast<wmfGetPixelFormat>(GPA( "wglGetPixelFormat" ));
	qwglSetPixelFormat           = reinterpret_cast<wmfSetPixelFormat>(GPA( "wglSetPixelFormat" ));
	qwglSwapBuffers              = reinterpret_cast<wmfSwapBuffers>(GPA( "wglSwapBuffers" ));
