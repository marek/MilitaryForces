/*
 * $Id: ui_playersettings.c,v 1.1 2001-11-15 15:47:38 moorman Exp $
*/
...
static void PlayerSettings_DrawName( void *self ) {
	...
	Q_CleanStr( name );
	UI_DrawProportionalString( 320, 440, name, UI_CENTER|UI_BIGFONT, color_grey );//text_color_normal );
}
...
static void PlayerSettings_MenuInit( void ) {
	...
	s_playersettings.banner.generic.y     = 80;
...
//	s_playersettings.player.height				= 56*10;
	...
	s_playersettings.back.generic.name			= ART_BACK;
	...
	s_playersettings.back.generic.y				= 425;
	s_playersettings.back.width					= 96;
	s_playersettings.back.height				= 32;
	s_playersettings.back.focuspic				= ART_BACK_A;
