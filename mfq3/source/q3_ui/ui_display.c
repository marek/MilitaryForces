/*
 * $Id: ui_display.c,v 1.1 2001-11-15 21:35:14 thebjoern Exp $
*/
...
===============
*/
static void DisplayOptions_Draw( void ) {
...
static void UI_DisplayOptionsMenu_Init( void ) {
	...
	displayOptionsInfo.menu.draw = DisplayOptions_Draw;
	...
	displayOptionsInfo.banner.generic.y			= 80;
	...
	displayOptionsInfo.back.generic.name		= ART_BACK;
	...
	displayOptionsInfo.back.generic.y			= 425;
	displayOptionsInfo.back.width				= 96;
	displayOptionsInfo.back.height				= 32;
	displayOptionsInfo.back.focuspic			= ART_BACK_A;
