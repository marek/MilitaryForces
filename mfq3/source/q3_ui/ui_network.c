/*
 * $Id: ui_network.c,v 1.1 2001-11-15 21:35:14 thebjoern Exp $
*/
...
/*
===============
NetworkOptionsOptions_Draw
===============
*/
static void NetworkOptionsOptions_Draw( void ) {
...
static void UI_NetworkOptionsMenu_Init( void ) {
	...
	networkOptionsInfo.menu.draw = NetworkOptionsOptions_Draw;
	...
	networkOptionsInfo.banner.generic.y			= 80;
	...
	networkOptionsInfo.back.generic.name		= ART_BACK;
	...
	networkOptionsInfo.back.generic.y			= 425;
	networkOptionsInfo.back.width				= 96;
	networkOptionsInfo.back.height				= 32;
	networkOptionsInfo.back.focuspic			= ART_BACK_A;
