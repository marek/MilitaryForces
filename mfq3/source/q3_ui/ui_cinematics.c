/*
 * $Id: ui_cinematics.c,v 1.1 2001-11-15 21:35:14 thebjoern Exp $
*/
...
//	int		y;
	...
	cinematicsMenuInfo.menu.draw = CinematicsMenu_Draw;
...
*/
	...
	cinematicsMenuInfo.back.generic.name			= ART_BACK;
	cinematicsMenuInfo.back.generic.flags			= QMF_LEFT_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	cinematicsMenuInfo.back.generic.id				= ID_BACK;
	cinematicsMenuInfo.back.generic.callback		= UI_CinematicsMenu_BackEvent;
	cinematicsMenuInfo.back.generic.x				= 10;
	cinematicsMenuInfo.back.generic.y				= 180;
	cinematicsMenuInfo.back.width					= 128;
	cinematicsMenuInfo.back.height					= 16;
	cinematicsMenuInfo.back.focuspic				= ART_BACK_A;
