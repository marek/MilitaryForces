/*
 * $Id: ui_sound.c,v 1.1 2001-11-15 21:35:14 thebjoern Exp $
*/
...
/*
===============
SoundOptionsMenu_Draw
===============
*/
static void SoundOptionsMenu_Draw( void ) {
...
static void UI_SoundOptionsMenu_Init( void ) {
	...
	soundOptionsInfo.menu.draw = SoundOptionsMenu_Draw;
	...
	soundOptionsInfo.banner.generic.y			= 80;
...
*/
	...
	soundOptionsInfo.back.generic.name			= ART_BACK;
	...
	soundOptionsInfo.back.generic.y				= 425;
	soundOptionsInfo.back.width					= 96;
	soundOptionsInfo.back.height				= 32;
	soundOptionsInfo.back.focuspic				= ART_BACK_A;
