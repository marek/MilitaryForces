/*
 * $Id: ui_demo2.c,v 1.1 2001-11-15 21:35:14 thebjoern Exp $
*/
...
===============
*/
static void DemosMenu_Draw( void ) {
...
//	char	*demoname;
	...
	s_demos.menu.draw = DemosMenu_Draw;
...
*/
	...
	s_demos.back.generic.name		= ART_BACK;
	s_demos.back.generic.flags		= QMF_LEFT_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	s_demos.back.generic.id			= ID_BACK;
	s_demos.back.generic.callback	= Demos_MenuEvent;
	s_demos.back.generic.x			= 10;
	s_demos.back.generic.y			= 180;
	s_demos.back.width				= 128;
	s_demos.back.height				= 16;
	s_demos.back.focuspic			= ART_BACK_A;
/*
...
*/
#pragma message("change the extension from dm3 to _mfq3.dm3 and make sure all demos follow this naming convention!")
/*
