/*
 * $Id: ui_teamorders.c,v 1.1 2001-11-15 21:35:14 thebjoern Exp $
*/
...
static void UI_TeamOrdersMenu_Init( void ) {
	...
	teamOrdersMenuInfo.banner.generic.y			= 105;
	teamOrdersMenuInfo.banner.string			= "TEAM ORDERS";
	teamOrdersMenuInfo.banner.color				= color_black;
	...
	teamOrdersMenuInfo.back.generic.name		= ART_BACK;
	...
	teamOrdersMenuInfo.back.generic.x			= 170;
	teamOrdersMenuInfo.back.generic.y			= 330;
	teamOrdersMenuInfo.back.width				= 96;
	teamOrdersMenuInfo.back.height				= 32;
	teamOrdersMenuInfo.back.focuspic			= ART_BACK_A;
