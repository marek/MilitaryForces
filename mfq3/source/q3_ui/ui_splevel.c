/*
 * $Id: ui_splevel.c,v 1.1 2001-11-15 21:35:14 thebjoern Exp $
*/
...
*/
	...
	levelMenuInfo.item_back.generic.name			= ART_BACK;
	levelMenuInfo.item_back.generic.flags			= QMF_LEFT_JUSTIFY|QMF_HIGHLIGHT_IF_FOCUS;
	levelMenuInfo.item_back.generic.x				= 10;
	levelMenuInfo.item_back.generic.y				= 180;
	...
	levelMenuInfo.item_back.height					= 16;
	levelMenuInfo.item_back.focuspic				= ART_BACK_A;
/*
