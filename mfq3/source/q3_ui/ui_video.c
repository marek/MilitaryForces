/*
 * $Id: ui_video.c,v 1.1 2001-11-15 21:35:14 thebjoern Exp $
*/
...
#define DRIVERINFO_LOGO		"menu/art/background_sub"
#define DRIVERINFO_BACK		"menu/art/back"
#define DRIVERINFO_BACK_A	"menu/art/back_a"
...
static void UI_DriverInfo_Menu( void )
{
	...
	s_driverinfo.back.generic.name     = DRIVERINFO_BACK;
	...
	s_driverinfo.back.generic.y		   = 425;
	s_driverinfo.back.width  		   = 96;
	s_driverinfo.back.height  		   = 32;
	s_driverinfo.back.focuspic         = DRIVERINFO_BACK_A;
...
#define GRAPHICSOPTIONS_LOGO		"menu/art/background_sub"
#define GRAPHICSOPTIONS_BACK		"menu/art/back"
#define GRAPHICSOPTIONS_BACK_A		"menu/art/back_a"
#define GRAPHICSOPTIONS_ACCEPT		"menu/art/accept"
#define GRAPHICSOPTIONS_ACCEPT_A	"menu/art/accept_a"
...
{
	UI_DrawNamedPic( 0, 0, 640, 480, GRAPHICSOPTIONS_LOGO );
...
void GraphicsOptions_MenuInit( void )
{
	...
	s_graphicsoptions.banner.generic.y	   = 80;
...
//	y += BIGCHAR_HEIGHT+2;
	...
	s_graphicsoptions.back.generic.name     = GRAPHICSOPTIONS_BACK;
	...
	s_graphicsoptions.back.generic.y		= 425;
	s_graphicsoptions.back.width  		    = 96;
	s_graphicsoptions.back.height  		    = 32;
	s_graphicsoptions.back.focuspic         = GRAPHICSOPTIONS_BACK_A;

	s_graphicsoptions.apply.generic.type     = MTYPE_BITMAP;
	s_graphicsoptions.apply.generic.name     = GRAPHICSOPTIONS_ACCEPT;
	...
	s_graphicsoptions.apply.generic.x        = 522;
	s_graphicsoptions.apply.generic.y        = 425;
	s_graphicsoptions.apply.width  		     = 96;
	s_graphicsoptions.apply.height  		 = 32;
	s_graphicsoptions.apply.focuspic         = GRAPHICSOPTIONS_ACCEPT_A;
...
void GraphicsOptions_Cache( void ) {
	trap_R_RegisterShaderNoMip( GRAPHICSOPTIONS_LOGO );
	trap_R_RegisterShaderNoMip( GRAPHICSOPTIONS_BACK );
	trap_R_RegisterShaderNoMip( GRAPHICSOPTIONS_BACK_A );
	trap_R_RegisterShaderNoMip( GRAPHICSOPTIONS_ACCEPT );
	trap_R_RegisterShaderNoMip( GRAPHICSOPTIONS_ACCEPT_A );
}
